...
public abstract class UIESlider extends UIEClickZone {
    ...
    public UIESlider(CustomColor backColor, Texture sliderButton, float anchorX, float anchorY, int offsetX, int offsetY, int width, boolean active, float min, float max, float precision, float progress) {
        super(anchorX, anchorY, offsetX, offsetY, width, MathHelper.fastFloor(sliderButton.height/3), active, null);
    ...
    public static class Horizontal extends UIESlider {
        public Horizontal(CustomColor backColor, Texture sliderButton, float anchorX, float anchorY, int offsetX, int offsetY, int width, boolean active, float min, float max, float precision, float progress) {
            super(backColor, sliderButton, anchorX, anchorY, offsetX, offsetY, width, active, min, max, precision, progress);
        }
