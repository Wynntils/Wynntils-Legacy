...
public class CharacterSelectorUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        mc.player.setInvisible(false); // removes invisibility from class selection
    ...
    private void drawSelector() {
        renderer.drawRect(Textures.UIs.class_selection, 0, 0, 118, 254, 0, 0, 118, 254);
        ...
        // new character button
        {
            ...
            renderer.drawRect(Textures.UIs.class_selection, 26, 232, 26 + 14, 232 + 14,
                    (createCharacterSlot != -1) ? 154 : 197,
                    102,
                    (createCharacterSlot != -1) ? 168 : 216,
                    116);
        }
        ...
        // edit character button
        {
            ...
            renderer.drawRect(Textures.UIs.class_selection, 51, 231, 51 + 8, 231 + 16,
                    182, 102,
                    190, 118);
        }
        ...
        // delete character button
        {
            ...
            renderer.drawRect(Textures.UIs.class_selection, 70, 232, 70 + 14, 232 + 14,
    ...
    private void drawSelectedBadge(int soulPoints, int quests, float xpPercentage) {
        ...
        // base
        renderer.drawRect(Textures.UIs.class_selection, posX, posY, posX + 123, posY + 38, 118, 0, 241, 38);
        ...
        // soulPoint
        {
            ...
            renderer.drawRect(Textures.UIs.class_selection, posX + 13, posY + 6, posX + 13 + 10, posY + 22, 144, 102, 154, 118);
        ...
        // quests
        {
            ...
            renderer.drawRect(Textures.UIs.class_selection, posX + 46, posY + 6, posX + 46 + 16, posY + 22, 128, 102, 144, 118);
        ...
        // game modes
        {
            ...
            renderer.drawRect(Textures.UIs.class_selection, posX + 86, posY + 7, posX + 87 + 8, posY + 21, 119, 102, 128, 116);
        }
    ...
    private void drawPlayer() {
        ...
        renderer.drawRect(Textures.UIs.class_selection, 220, 198, 220 + 76, 198 + 22, 118, 131, 194, 153);
    ...
    private void drawCharacterBadge(int posX, int posY, ItemStack item, String name, String level, String deletion, float xp, boolean selected, int id) {
        if (deletion.isEmpty()) {
            if (mouseX >= posX && mouseY >= posY && mouseX <= posX + 104 && mouseY <= posY + 32) { // mouse over
                hoveredButton = id;
            }
        } else {
        ...
        // base
        {
            renderer.drawRect(Textures.UIs.class_selection, posX, posY, posX + 104, posY + 32, 118, selected ? 70 : 38, 222, selected ? 102 : 70);
        }
        ...
        // class deletion
        {
            if (!deletion.isEmpty()) {
                if (mouseX >= posX + 79 && mouseY >= posY + 4 && mouseX <= posX + 79 + 16 && mouseY <= posY + 16 + 4) {
                    hoveredButton = 58;
                    hoveredText = Arrays.asList(
                            TextFormatting.DARK_RED + "" + TextFormatting.BOLD + "[X] This class is being deleted",
                            TextFormatting.GRAY + "Total deletion in " + TextFormatting.RED + deletion,
                            "",
                            TextFormatting.GOLD + "> Click here to cancel"
                    );
                }
                renderer.drawRect(Textures.UIs.class_selection, posX + 79, posY + 4, posX + 79 + 16, posY + 16 + 4, 197, 131, 209, 147);
            }
        }
    }
    ...
    private void drawPlayButton(boolean selected) {
        if (mouseX >= 385 && mouseY >= 205 && mouseX <= 385 + 79 && mouseY <= 205 + 39) { // mouse over
            ...
            if (selected) {
                ...
                hoveredText = Arrays.asList(
                        TextFormatting.DARK_GRAY + "" + TextFormatting.BOLD + "[X] You need to select a class.",
                        TextFormatting.GRAY + "Please create or select a new class.");
            }
        } else {
            color(0.8f, 0.8f, 0.8f, 1f);
        }

        renderer.drawRect(Textures.UIs.class_selection, 385, 205, 385 + 79, 205 + 39, 118,
    ...
    private void drawExperienceBar(int posX, int posY, float progress) {
        ...
        renderer.drawRect(Textures.UIs.class_selection, posX, posY, posX + 100, posY + 6, 118, 119, 218, 125);
        renderer.drawRect(Textures.UIs.class_selection, posX, posY, posX + (int) (100 * progress), posY + 6, 118, 125,
    ...
    private void drawBackground(BufferBuilder builder, Tessellator tes) {
        ...
        VisualModule.getModule().getClassSelectionSplash().bindTexture();
