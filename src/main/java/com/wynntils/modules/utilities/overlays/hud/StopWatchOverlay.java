...
public class StopWatchOverlay extends Overlay {
    ...
    public StopWatchOverlay() {
        super("Stop Watch", 60, 10, true, true, 0, 1f, 10, -15, OverlayGrowFrom.TOP_LEFT, RenderGameOverlayEvent.ElementType.EXPERIENCE, RenderGameOverlayEvent.ElementType.JUMPBAR);
    }
