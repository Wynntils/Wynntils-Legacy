...
public class OverlayConfig extends SettingsClass {
    ...
    public static class GameUpdate extends SettingsClass {
        ...
        public static class RedirectSystemMessages extends SettingsClass {
            ...
            @Setting(displayName = "Redirect Emerald Pouch Messages", description = "Should messages about emeralds being added to your emerald pouch be redirected to the game update ticker?")
