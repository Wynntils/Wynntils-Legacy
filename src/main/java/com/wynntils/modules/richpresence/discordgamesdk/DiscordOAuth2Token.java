...
public class DiscordOAuth2Token extends Structure {
    ...
    public DiscordOAuth2Token(byte access_token[], byte scopes[], long expires) {
        super();
        if ((access_token.length != this.access_token.length)) throw new IllegalArgumentException("Wrong array size !");
        this.access_token = access_token;
        if ((scopes.length != this.scopes.length)) throw new IllegalArgumentException("Wrong array size !");
        this.scopes = scopes;
