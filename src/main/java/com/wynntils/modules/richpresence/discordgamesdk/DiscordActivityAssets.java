...
public class DiscordActivityAssets extends Structure {
    ...
    public DiscordActivityAssets(byte large_image[], byte large_text[], byte small_image[], byte small_text[]) {
        super();
        if ((large_image.length != this.large_image.length)) throw new IllegalArgumentException("Wrong array size !");
        this.large_image = large_image;
        if ((large_text.length != this.large_text.length)) throw new IllegalArgumentException("Wrong array size !");
        this.large_text = large_text;
        if ((small_image.length != this.small_image.length)) throw new IllegalArgumentException("Wrong array size !");
        this.small_image = small_image;
        if ((small_text.length != this.small_text.length)) throw new IllegalArgumentException("Wrong array size !");
