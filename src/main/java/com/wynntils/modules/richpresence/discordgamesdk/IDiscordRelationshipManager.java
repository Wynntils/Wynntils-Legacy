...
/**
 * <i>native declaration : line 439</i><br>
...
public class IDiscordRelationshipManager extends Structure implements DiscordGameSDKOptions {
    ...
    public IDiscordRelationshipManager.count_callback count;
    /** C type : get_callback* */
    ...
    public interface count_callback extends Callback, DiscordGameSDKOptions {
        EDiscordResult apply(IDiscordRelationshipManager manager, IntByReference count);
    };

    public interface get_callback extends Callback, DiscordGameSDKOptions {
        EDiscordResult apply(IDiscordRelationshipManager manager, long user_id, DiscordRelationship relationship);
    };

    public interface get_at_callback extends Callback, DiscordGameSDKOptions {
        EDiscordResult apply(IDiscordRelationshipManager manager, int index, DiscordRelationship relationship);
    };
     ...
     */
    public IDiscordRelationshipManager(IDiscordRelationshipManager.filter_callback filter, IDiscordRelationshipManager.count_callback count, IDiscordRelationshipManager.get_callback get, IDiscordRelationshipManager.get_at_callback get_at) {
        super();
        this.filter = filter;
        this.count = count;
        this.get = get;
