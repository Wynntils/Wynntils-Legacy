...
public class ChatConfig extends SettingsClass {
    ...
    public TranslateConditions translateCondition = TranslateConditions.always;//12
    ...
    @Setting(displayName = "Wynnic/Gavellian Colors", description = "Should Wynnic be colored green and Gavellian purple?", order = 14)
