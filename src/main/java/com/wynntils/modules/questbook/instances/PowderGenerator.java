...
public class PowderGenerator {
    private static final Map<Powder, List<PowderProfile>> powderProfileMap = new HashMap<Powder, List<PowderProfile>>() {{
        put(Powder.WATER,
                Arrays.asList(new PowderProfile(Powder.WATER, 1, 3, 4, 13, 3, 1),
        ...
        put(Powder.FIRE,
                Arrays.asList(new PowderProfile(Powder.FIRE, 1, 2, 5, 14, 3, 1),
        ...
        put(Powder.AIR,
                Arrays.asList(new PowderProfile(Powder.AIR, 1, 2, 6, 11, 3, 1),
        ...
        put(Powder.EARTH,
                Arrays.asList(new PowderProfile(Powder.EARTH, 1, 3, 6, 17, 2, 1),
        ...
        put(Powder.THUNDER,
                Arrays.asList(new PowderProfile(Powder.THUNDER, 1, 1, 8, 9, 3, 1),
