...
public class WynnRenderItem extends RenderItem {
    ...
    public static void inject() {
        ...
        ScreenRenderer.itemRenderer = instance;
    }
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
        RenderEvent.DrawItemOverlay.Pre pre = new RenderEvent.DrawItemOverlay.Pre(stack, xPosition, yPosition, text);

        FrameworkManager.getEventBus().post(pre);

        if (!pre.isOverlayTextChanged()) {
            ...
            int width = ScreenRenderer.fontRenderer.getStringWidth(pre.getOverlayText());
            ...
            ScreenRenderer.fontRenderer.drawString(pre.getOverlayText(), 0, 0, pre.getOverlayTextColor(),
        ...
        RenderEvent.DrawItemOverlay.Post post = new RenderEvent.DrawItemOverlay.Post(stack, xPosition, yPosition, text);

        FrameworkManager.getEventBus().post(post);
    }
