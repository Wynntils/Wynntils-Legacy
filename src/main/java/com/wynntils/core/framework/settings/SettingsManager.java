...
public class SettingsManager {
    ...
    public static void saveSettings(ModuleContainer m, SettingsHolder obj) throws Exception {
        ...
        f = new File(f, m.getInfo().name() + "-" + (obj instanceof Overlay ? "overlay_" + ((Overlay)obj).name.toLowerCase(Locale.ROOT).replace(" ", "_") : info.name()) + ".config");
    ...
    public static SettingsHolder getSettings(ModuleContainer m, SettingsHolder obj, SettingsContainer container) throws Exception {
        ...
        String configFile = m.getInfo().name() + "-" + (obj instanceof Overlay ? "overlay_" + ((Overlay)obj).name.toLowerCase(Locale.ROOT).replace(" ", "_") : info.name()) + ".config";
