...
public class GuiWynnSound extends GuiScreenMod {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(fontRenderer,"sound - Wynncraft Music recreations",(width/2),20,2.0f,Integer.parseInt("FFFFFF",16));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id) {
            case 0:
                try {Desktop.getDesktop().browse(new URI("http://www.mediafire.com/file/5uhorbq77yqzfvy/sound+-+XavierEXE.zip"));} catch(Exception ignored){}
                break;
            case 1:
                WynnSound.Toggle();
                break;
