...
public class GuiPartyChatbox extends GuiScreen implements ITabCompleter {
    ...
    private final String partyChatStr = "/p ";
    /**
     * Chat entry field
     */
    ...
    public GuiPartyChatbox(PartyChat chat) {
        this.chat = chat;
        this.mc = Minecraft.getMinecraft();
    }

    public GuiPartyChatbox(PartyChat chat, String defaultText) {
        this(chat);
    ...
    public void initGui() {
        ...
        this.inputField = new GuiTextField(0, this.fontRenderer, this.mc.fontRenderer.getStringWidth(this.partyChatStr) + 7, this.height - 12, this.width - 4, 12);
    ...
    protected void keyTyped(char typedChar, int keyCode) {
        ...
        if (keyCode == 1) {
            ...
            if (!s.isEmpty()) {
                this.sendChatMessage("/p " + s, false);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        drawRect(mc.fontRenderer.getStringWidth(this.partyChatStr) + 5, this.height - 14, this.width - 2, this.height - 2, Integer.MIN_VALUE);
        drawRect(3, this.height - 14, mc.fontRenderer.getStringWidth(this.partyChatStr) + 4, height - 2, Integer.MIN_VALUE);
        this.drawString(mc.fontRenderer, this.partyChatStr, 5, this.height - 12, 0xAAAAAA);
