...
public class GuiPartyChat extends Gui {
    ...
    public GuiPartyChat(Minecraft mcIn, PartyChat chat) {
        this.mc = mcIn;
    }
    ...
    private int _width() {
        ...
        return scale.getScaledWidth();
    }

    public void drawChat() {
        drawChat(this.mc.ingameGUI.getUpdateCounter());
    }

    public void drawChat(int updateCounter) {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) { //Add option to turn on and off chat here
            int x = MathHelper.ceil((float) (this._width() - this.getChatWidth()) / this.getChatScale());
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                drawRect(x - 2, j2 - 9, x + k + 4, j2, l1 / 2 << 24);
                                String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                this.mc.fontRenderer.drawStringWithShadow(s, x, (float) (j2 - 8), 16777215 + (l1 << 24));
    ...
    public boolean getChatOpen() {
        return this.mc.currentScreen instanceof GuiPartyChatbox;
    }
